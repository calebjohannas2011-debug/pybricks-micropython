...
#define PYBRICKS_PY_COMMON_LOGGER               (0) // FORCED OFF: Prevents compiling pb_type_logger.c
...
#define PYBRICKS_PY_IODEVICES                   (0) // Turned off to prevent cascading logger dependencies
...
#define PYBRICKS_PY_TOOLS                       (0) // FORCED OFF: Prevents background links to logger
