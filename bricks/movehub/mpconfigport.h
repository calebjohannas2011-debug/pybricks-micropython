...
#define PYBRICKS_PY_COMMON_CHARGER              (0) // Move Hub uses standard batteries
#define PYBRICKS_PY_COMMON_COLOR_LIGHT          (1) 
#define PYBRICKS_PY_COMMON_CONTROL              (0) // Disabled to save space for Level 2
#define PYBRICKS_PY_COMMON_IMU                  (0) // Disabled to save space for Level 2
#define PYBRICKS_PY_COMMON_KEYPAD               (1)
#define PYBRICKS_PY_COMMON_KEYPAD_HUB_BUTTONS   (1) // Move Hub only has 1 button
#define PYBRICKS_PY_COMMON_LIGHT_ARRAY          (0)
#define PYBRICKS_PY_COMMON_LIGHT_MATRIX         (0) 
#define PYBRICKS_PY_COMMON_LOGGER               (0) 
#define PYBRICKS_PY_COMMON_MOTOR_MODEL          (0) 
#define PYBRICKS_PY_COMMON_MOTORS               (1) // KEPT: Core Motor Support
...
#define PYBRICKS_PY_IODEVICES_LWP3_DEVICE       (1) // KEPT: Power Functions / Powered Up wireless protocol
#define PYBRICKS_PY_IODEVICES_PUP_DEVICE        (1) // KEPT: Standard device attachments
#define PYBRICKS_PY_IODEVICES_UART_DEVICE       (0)
#define PYBRICKS_PY_IODEVICES_XBOX_CONTROLLER   (0) // Disabled to save space
...
#define PYBRICKS_PY_PUPDEVICES_REMOTE           (0) // Disabled to save space
...
#define PYBRICKS_OPT_FLOAT                      (1) // Float math is required for many Level 2 features
#define PYBRICKS_OPT_TERSE_ERR                  (1) // Turned on to save byte space
#define PYBRICKS_OPT_EXTRA_LEVEL1               (1) // KEPT
#define PYBRICKS_OPT_EXTRA_LEVEL2               (1) // KEPT
